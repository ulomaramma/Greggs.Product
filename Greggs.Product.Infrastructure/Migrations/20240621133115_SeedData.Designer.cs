...
namespace Greggs.Products.Infrastructure.Migrations
{
    ...
    [Migration("20240621133115_SeedData")]
            ...
            modelBuilder.Entity("Greggs.Products.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductID = 1,
                            CategoryID = 3,
                            CreatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4755),
                            Description = "A delicious sausage roll.",
                            IsDeleted = false,
                            PriceInPounds = 1m,
                            ProductName = "Sausage Roll",
                            UpdatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4951)
                        },
                        new
                        {
                            ProductID = 2,
                            CategoryID = 3,
                            CreatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4962),
                            Description = "A tasty vegan sausage roll.",
                            IsDeleted = false,
                            PriceInPounds = 1.1m,
                            ProductName = "Vegan Sausage Roll",
                            UpdatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4963)
                        },
                        new
                        {
                            ProductID = 3,
                            CategoryID = 3,
                            CreatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4967),
                            Description = "A savory steak bake.",
                            IsDeleted = false,
                            PriceInPounds = 1.2m,
                            ProductName = "Steak Bake",
                            UpdatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4968)
                        },
                        new
                        {
                            ProductID = 4,
                            CategoryID = 6,
                            CreatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4970),
                            Description = "A sweet treat.",
                            IsDeleted = false,
                            PriceInPounds = 0.7m,
                            ProductName = "Yum Yum",
                            UpdatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4972)
                        },
                        new
                        {
                            ProductID = 5,
                            CategoryID = 6,
                            CreatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4974),
                            Description = "A delicious pink jammie.",
                            IsDeleted = false,
                            PriceInPounds = 0.5m,
                            ProductName = "Pink Jammie",
                            UpdatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4975)
                        },
                        new
                        {
                            ProductID = 6,
                            CategoryID = 5,
                            CreatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4978),
                            Description = "A spicy Mexican baguette.",
                            IsDeleted = false,
                            PriceInPounds = 2.1m,
                            ProductName = "Mexican Baguette",
                            UpdatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4980)
                        },
                        new
                        {
                            ProductID = 7,
                            CategoryID = 1,
                            CreatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4982),
                            Description = "A delicious bacon sandwich.",
                            IsDeleted = false,
                            PriceInPounds = 1.95m,
                            ProductName = "Bacon Sandwich",
                            UpdatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4983)
                        },
                        new
                        {
                            ProductID = 8,
                            CategoryID = 4,
                            CreatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4986),
                            Description = "A refreshing Coca Cola.",
                            IsDeleted = false,
                            PriceInPounds = 1.2m,
                            ProductName = "Coca Cola",
                            UpdatedDate = new DateTime(2024, 6, 21, 14, 31, 15, 291, DateTimeKind.Local).AddTicks(4987)
                        });
                });
